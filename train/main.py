...
train_config = TrainingArguments(
    output_dir=f'{args.ckpt}/t{args.template}_{args.description}_{args.question}/{args.name}_{args.seed}',
    eval_strategy='epoch',
...
if args.task == 'train':
    ...
    ckpt_dir = f'{args.ckpt}/t{args.template}_{args.description}_{args.question}/{args.name}_{args.seed}'
    ...
    with open(f'{args.pred}/template{args.template}_{args.description}_{args.question}_{args.name}_{args.seed}_ft.jsonl', 'w') as f:
